import type { ProviderCategory, MimoCodeProviderConfig } from "../types";
...
export interface MimoCodeProviderPreset {
  ...
  websiteUrl: string;
  apiKeyUrl?: string;
  settingsConfig: MimoCodeProviderConfig;
  isOfficial?: boolean;
  isPartner?: boolean;
...
export const MIMOCODE_PRESET_MODEL_VARIANTS: Record<
  string,
  PresetModelVariant[]
> = {
...
export function getPresetModelDefaults(
  ...
  const models = MIMOCODE_PRESET_MODEL_VARIANTS[npm];
...
export const mimocodeProviderPresets: MimoCodeProviderPreset[] = [
  ...
  },
  {
    ...
    settingsConfig: {
      ...
      models: {
        "claude-sonnet-4-5": { name: "Claude Sonnet 5" },
        "claude-opus-4-8": { name: "Claude Opus 4.8" },
      },
    },
    category: "aggregator",
